...
{
    public partial class FormDocA : Form
    {
        public FormDocA()
        {
            InitializeComponent();
        ...
        private void FormDocA_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbCommand cmdSelectParcel = new OleDbCommand("INSERT INTO DoctorArea VALUES ('" + DID + AID + "')", conDataBase);
                OleDbDataReader myReader;
                MessageBox.Show("Doc Area Added Successfully!");
                conDataBase.Open();
