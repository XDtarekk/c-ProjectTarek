...
{
    public partial class FormPCRhistory : Form
    {
        public FormPCRhistory()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand cmdSelectParcel = new OleDbCommand("SELECT ct.TDate FROM CovidTest AS ct, PCR AS p WHERE p.TID = ct.TID AND ct.PID ='" + x + "'", conDataBase);
